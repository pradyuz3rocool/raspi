...
func main() {
	topic := flag.String("topic", "topic", "The topic name to/from which to publish/subscribe")
	broker := flag.String("broker", "tcp://192.168.1.74:1883", "The broker URI. ex: tcp://10.10.1.1:1883")
	password := flag.String("password", "password", "The password (optional)")
	user := flag.String("user", "username", "The User (optional)")
	id := flag.String("id", "host", "The ClientID (optional)")
